...
watchEffect(async () => {
  store.getDepartamento({ id: route.params.id });
  storeCentroCusto.getCentrosCusto();
...
<template>
  <div class="container">
    <form @submit.prevent="store.updateDepartamento({ id: route.params.id })" novalidate>
      <div class="flex flex-col mx-auto md:w-96 w-full">
        <div class="card">
          <div class="card-body">
            <h1 class="text-2xl font-bold mb-4 text-center">Alterar departamento</h1>
            ...
            <div class="flex flex-col gap-2 mb-4">
              ...
              <select v-model="store.form.centro_custo_id" class="form-input" :disabled="store.loading">
                ...
                <option v-for="centroCusto in storeCentroCusto.centrosCusto" :key="centroCusto.id" :value="centroCusto.id"
                  :selected="store.form.centro_custo_id == centroCusto.id">
                  {{ centroCusto.titulo }}
                </option>
              </select>
